...
private:
	...
	QPushButton *restBtn, *addBtn, *deleteBtn, *store, *updateBtn, *storeUpdate, *searchBtn, *filterByTitleBtn, *filterByYearBtn, *sortByTitleBtn, *sortByAuthorBtn, *sortByYearAndSubjectBtn, *filterByTitleSlotBtn, *filterByYearSlotBtn, *undo;
};
